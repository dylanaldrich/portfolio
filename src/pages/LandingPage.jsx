    ...
    return (
        <div>
                ...
                <div className="container row text-white text-left my-3">
                    <div id="about-content" className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p className="lead">
                                I’m a worldly, multilingual software developer with a background in web development, the music industry and education. As a creative problem solver, I am passionate about using technology to bring people closer together, and closer to achieving their dreams. Based in Los Angeles, CA.
                            </p>
            ...
            <section id="projects">
                ...
                {/* Song Quiz Section */}
                <div className="project-container d-flex align-items-center text-white mb-5" id="song-quiz-section">
                    <div className="project container d-flex align-items-center">
